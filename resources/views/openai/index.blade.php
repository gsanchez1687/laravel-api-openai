                    ...
                    <form class="mt-6 space-y-6" action="{{ route('openai.index') }}" method="get">
                        <div>
                            <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="search">
                                Text to search in API ChatGPT
                            </label>
                            <input id="search" name="search" type="text" value="{{ request()->get('search') }}" required="required" autofocus="autofocus" autocomplete="search" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full">
                        </div>
